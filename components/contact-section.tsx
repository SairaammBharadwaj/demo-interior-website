    ...
    <>
      <div className="grid gap-10 md:grid-cols-[0.9fr_1.1fr]">
        <motion.div
          ...
          className="space-y-6"
        >
          <div className="group rounded-[24px] border border-border bg-[linear-gradient(160deg,rgba(255,255,255,0.88),rgba(176,117,82,0.08))] p-8 transition-all duration-300 hover:-translate-y-1 hover:border-accent/40">
        ...
        <motion.div
          ...
          className="overflow-hidden rounded-[28px] border border-border bg-[linear-gradient(160deg,rgba(255,255,255,0.92),rgba(176,117,82,0.06))]"
        >
      ...
      <motion.form
        ...
        className="mt-16 grid gap-8 rounded-[28px] border border-border bg-[linear-gradient(160deg,rgba(255,255,255,0.92),rgba(176,117,82,0.08))] px-6 py-10 backdrop-blur-sm shadow-soft md:px-10"
      >
        ...
        <div>
          <button
            ...
            suppressHydrationWarning
            disabled={isSending}
            className="rounded-full border border-border px-7 py-3 text-[0.78rem] uppercase tracking-[0.24em] transition-colors duration-300 hover:border-accent hover:bg-accent/10 hover:text-accent disabled:cursor-not-allowed disabled:opacity-60"
          >
